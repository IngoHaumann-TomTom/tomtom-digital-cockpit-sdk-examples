...
[`api_common_vehiclefunctions`](TTIVI_INDIGO_API) module we define the different types of vehicle 
properties and how we communicate with them.
...
[`com.tomtom.ivi.api.common.vehiclefunctions`](TTIVI_INDIGO_API) package documentation for more 
examples.
