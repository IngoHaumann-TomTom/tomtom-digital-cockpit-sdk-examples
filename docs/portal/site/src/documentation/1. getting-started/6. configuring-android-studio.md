...
Note that you will need Android Studio version Arctic Fox 2020.3.1 or newer.
...
Next step: [The IndiGO emulator](/indigo/documentation/getting-started/the-indigo-emulator).
