...
platform (see [`com.tomtom.ivi.api.framework.frontend.panels`](TTIVI_INDIGO_API)). For this example 
we will create a [`Panel`](TTIVI_INDIGO_API) class inheriting from the 
