...
in a more visually-prominent fashion (in bold and with a bigger font size) and the
...
behavior, the [ToggleActionMediaControl](TTIVI_INDIGO_API) specialization fits the use case better:
