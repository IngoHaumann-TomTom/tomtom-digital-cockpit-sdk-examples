...
In IndiGO, the
[System UI](/indigo/documentation/developing/system-ui)
...
[Theming](/indigo/documentation/developing/theming-and-customization.html)
documentation.
...
- You can provide a sticky header. This is a header view that is always shown at the top of the
  [TtRecyclerView](TTIVI_ANDROID_TOOLS_API) and does not disappear while scrolling.
...
![A TtScrollBar integrating a TtRecyclerView](images/ui-components-scrollbar.png)
