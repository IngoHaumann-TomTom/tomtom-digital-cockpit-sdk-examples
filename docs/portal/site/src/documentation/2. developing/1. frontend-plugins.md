...
contains the classes needed to create your own frontend, panel, and fragment using a viewmodel for the 
data-binding.
...
in the package `com.tomtom.ivi.api.framework.frontend.panels`. Which panel to derive from depends on 
