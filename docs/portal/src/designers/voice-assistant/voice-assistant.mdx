...
The in-vehicle Voice Personal Assistant (VPA) is a digital assistant that uses voice recognition to
help users complete their daily tasks without being distracted while driving. All communication
between the user and any voice assistant is either vocal only or a vocal and visual response.
...
- Pressing the `Push to talk` (PTT) button or an on-screen `Tap to talk` (TTT) button to directly
...
![voice chrome status control](images/vpa-voice-chrome-status-control.png)
...
by using only voice response.

![customization](images/vpa-customization.png)

| Section | Use |
| ------- | --- |
| 1. Full visual response (template) | The complete visual template version is recommended to be used while parked. |
| 2. Short visual response | Short version of the template. |
| 3. Voice only | No visual response, except for the voice chrome, is recommended while driving. |
...
![navigation user flow](images/vpa-navigation-user-flow.png)

![navigation template](images/vpa-navigation-template.png)
...
![navigation poi details user flow](images/vpa-poi-details-user-flow.png)

![poi details template](images/vpa-poi-details-template.png)
...
| 3. Main POI info | Usually contains a phone number and address, depending on the data provider. |
...
![traffic details user flow](images/vpa-traffic-details-user-flow.png)

![traffic details template](images/vpa-traffic-details-template.png)
...
| 4. Address | Usually contains the location icon/image and full address, depending on the data provider. |
...
![weather user flow](images/vpa-weather-user-flow.png)

![weather template](images/vpa-weather-template.png)
...
![generic content user flow](images/vpa-generic-content-user-flow.png)

![generic content template](images/vpa-generic-content-template.png)
...
possible to interact with the list by voice. The amount of options in the list is customizable.

![generic list flow](images/vpa-generic-list-flow.png)

![generic list template](images/vpa-generic-list-template.png)
