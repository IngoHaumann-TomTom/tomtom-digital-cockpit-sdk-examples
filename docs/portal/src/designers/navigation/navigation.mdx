...
Clicking the _Route_ button will show the user the proposed route and the option to select an
...
![driving](images/navigation/driving.png)
...
![arriving](images/navigation/arriving.png)
...
![flow](images/navigation/flow.png)
