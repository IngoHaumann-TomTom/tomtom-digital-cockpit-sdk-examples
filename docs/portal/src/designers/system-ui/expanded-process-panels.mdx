...
The expanded process panel is a customizable container with a `Dismiss` button, a navigation bar, and
a content area.
...
Tapping the `Dismiss` button will close the expanded process panel.
...
| Content | The expanded process panel can be created with any content within the content area and navigation area. The `Dismiss` button however is not customizable. |
