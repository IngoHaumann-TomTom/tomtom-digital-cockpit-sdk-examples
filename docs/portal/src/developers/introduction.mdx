...
submenu:
    ...
    - title: "Platform Overview"
      url: "/tomtom-digital-cockpit/developers/platform-overview/what-is-tomtom-digital-cockpit"
    - title: "Product Walk-through"
      url: "/tomtom-digital-cockpit/developers/platform-overview/example-apps"
    - title: "Getting Started Guide"
      url: "/tomtom-digital-cockpit/developers/getting-started/introduction"
    - title: "Development Guide"
      url: "/tomtom-digital-cockpit/developers/development/introduction"
    - title: "Design Guide"
      url: "/tomtom-digital-cockpit/designers/introduction"
    - title: "Integration Guide"
      url: "/tomtom-digital-cockpit/developers/integrating/introduction"
    - title: "Tutorials"
      url: "/tomtom-digital-cockpit/developers/tutorials-and-examples/overview"
---

<iframe
    src="https://player.vimeo.com/video/772456182?h=e9a69f9768&title=0&portrait=0&color=44ABE0"
    style={{aspectRatio: '16 / 9', width: '100%', marginBottom: '3rem'}}
    frameborder="0"
    ...
    [
      {
        ...
        button: {
          ...
          href: '/tomtom-digital-cockpit/developers/platform-overview/what-is-tomtom-digital-cockpit'
        }
      },
      {
        title: 'Example App',
        ...
        button: {
          ...
          href: '/tomtom-digital-cockpit/developers/platform-overview/example-apps'
        }
      },
      {
        ...
        button: {
          ...
          href: '/tomtom-digital-cockpit/developers/getting-started/introduction'
        }
      },
      {
        ...
        button: {
          ...
          href: '/tomtom-digital-cockpit/developers/development/introduction'
        }
      },
      {
        ...
        button: {
          label: 'Design Guide',
          href: '/tomtom-digital-cockpit/designers/introduction'
        }
      },
      {
        ...
        button: {
          ...
          href: '/tomtom-digital-cockpit/developers/integrating/introduction'
        }
      },
      {
        title: 'Tutorials',
        ...
        button: {
          label: 'Tutorials',
          href: '/tomtom-digital-cockpit/developers/tutorials-and-examples/overview'
        }
      },
      {}
    ]
    ...
    [
      {
        ...
        button: {
          label: 'Read more',
          href: '/tomtom-digital-cockpit/developers/integrating/integrating-amazon-alexa'
        }
      },
      {
...
<Button label="Get Started" href="/tomtom-digital-cockpit/developers/getting-started/introduction" icon="arrow" />
