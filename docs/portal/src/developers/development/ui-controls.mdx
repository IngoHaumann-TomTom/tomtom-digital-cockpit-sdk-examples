...
[System UI](/tomtom-digital-cockpit/developers/development/system-ui)
...
can be found in the [Theming](/tomtom-digital-cockpit/developers/development/theming-and-customization)
documentation.
...
- Locking the view for driving safety.
