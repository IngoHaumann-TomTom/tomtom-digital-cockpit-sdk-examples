...
[`NavigablePanelViewModel`](TTIVI_PLATFORM_API)`.getNavigationBarViewModel()` based on this data.
...
[`NavigablePanelViewModel`](TTIVI_PLATFORM_API)`.getNavigationBarViewModel()` to the
