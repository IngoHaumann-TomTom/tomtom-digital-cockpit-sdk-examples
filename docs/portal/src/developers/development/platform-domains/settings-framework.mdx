...
Like [any IVI service](/tomtom-digital-cockpit/developers/development/ivi-services), a settings service
...
[IVI service deployment](/tomtom-digital-cockpit/developers/tutorials-and-examples/deployment/configure-the-runtime-deployment-of-the-ivi-system)
for details.
