...
See [Localize Strings](/tomtom-digital-cockpit/developers/tutorials-and-examples/localization/localize-strings)
...
See [Change Localization Settings](/tomtom-digital-cockpit/developers/tutorials-and-examples/localization/change-localization-settings)
