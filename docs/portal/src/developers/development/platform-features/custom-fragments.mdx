...
is usable for the custom fragment and if it's public API, you can reuse it. Otherwise, you can
...
[`GenericPanel`](TTIVI_PLATFORM_API). The first rule that accepts to create the fragment for a given
