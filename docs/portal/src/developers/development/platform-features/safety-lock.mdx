...
[_IVI instance_](/tomtom-digital-cockpit/developers/tutorials-and-examples/deployment/configure-the-runtime-deployment-of-the-ivi-system),
...
[`DrivingState.DRIVING`](TTIVI_PLATFORM_API) when the speed reported by NavKit exceeds 5
kilometers an hour.
...
configuration, see also [Configuration Framework](/tomtom-digital-cockpit/developers/development/platform-domains/configuration-framework).
