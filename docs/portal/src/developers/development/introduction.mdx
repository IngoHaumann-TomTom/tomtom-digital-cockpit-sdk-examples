...
off-the-shelf TomTom Digital Cockpit applications should be part of your product, and which ones
...
`com.tomtom.ivi.appsuite.xx`. You may consider these as delivered directly from stock, without
...
[frontend plugins](/tomtom-digital-cockpit/developers/development/frontend-plugins). These are created
...
[UI controls](/tomtom-digital-cockpit/developers/development/ui-controls) section.

The [System UI](/tomtom-digital-cockpit/developers/development/system-ui) section explains how _panels_
are arranged, managed and presented to the user on the screen.

Non UI related logic can be wrapped in an
[IVI service](/tomtom-digital-cockpit/developers/development/ivi-services), which provides a mechanism to
...
[Theming and Customization](/tomtom-digital-cockpit/developers/development/theming-and-customization),
...
[platform domains](/tomtom-digital-cockpit/developers/development/platform-domains/overview), which are
described separately. Next to to the various domains plugins can connect with, TomTom Digital Cockpit offers
a number of [platform features](/tomtom-digital-cockpit/developers/development/platform-features/overview)
