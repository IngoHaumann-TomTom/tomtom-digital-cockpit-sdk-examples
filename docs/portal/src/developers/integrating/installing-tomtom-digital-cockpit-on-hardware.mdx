...
used to sign the system apps on your Android platform, for it to be granted all the necessary
system permissions. If this is not possible, there will be some limitations; those are explained
later in this page.
...
- Install the Digital Cockpit APK that you have built, into the `/system/priv-app` directory on the
  ...
  [TomTom Digital Cockpit SDK example sources](/tomtom-digital-cockpit/getting-started/accessing-tomtom-digital-cockpit-sdk-example-sources).
