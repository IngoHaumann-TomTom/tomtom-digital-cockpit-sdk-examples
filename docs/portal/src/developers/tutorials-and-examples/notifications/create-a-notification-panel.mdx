...
[`StockNotificationPanel.Companion.create`](TTIVI_PLATFORM_API). You don't need to derive
...
create it by using [`StockNotificationPanel.Companion.create`](TTIVI_PLATFORM_API).
