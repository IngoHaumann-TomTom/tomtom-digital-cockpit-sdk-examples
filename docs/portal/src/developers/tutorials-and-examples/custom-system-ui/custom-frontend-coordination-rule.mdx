...
---
<Blockquote hasIcon>
    Knowledge of the system UI will help you to understand this guide. If you are not yet familiar
    with it, feel free to take a look at the
...
Such rules commonly trigger a `Panel` within a [`Frontend`](TTIVI_PLATFORM_API) to open,
...
[`DebugPanel`](TTIVI_PLATFORM_API) when a main menu item is clicked. Code snippets only show
...
2. The debug menu appears on the right of the screen.
3. Tap a main menu item.
4. The debug menu is automatically closed.
