...
<Blockquote type="announcement" hasIcon>
    [Additional requirements](https://developer.tomtom.com/tomtom-digital-cockpit/developers/integrating/integrating-amazon-alexa) exist for using Amazon Alexa in your TomTom Digital Cockpit product.
</Blockquote>
...
[Register your Alexa product with Amazon](/tomtom-digital-cockpit/developers/integrating/integrating-amazon-alexa#register-your-alexa-product-with-amazon)
page.
...
Follow the steps in
[Create a service implementation module](/tomtom-digital-cockpit/developers/tutorials-and-examples/voice-personal-assistant/create-a-custom-alexa-handler-service#create-a-service-implementation-module)
to create the initial `CustomCarControl` handler service module and in
[Implement the Alexa Handler service](/tomtom-digital-cockpit/developers/tutorials-and-examples/voice-personal-assistant/create-a-custom-alexa-handler-service#implement-the-alexa-handler-service)
...
[Parsing AASB messages](/tomtom-digital-cockpit/developers/tutorials-and-examples/voice-personal-assistant/create-a-custom-alexa-handler-service#parsing-aasb-messages).
...
Follow the steps in
[Create a service host](/tomtom-digital-cockpit/developers/tutorials-and-examples/voice-personal-assistant/create-a-custom-alexa-handler-service#create-a-service-host)
and
[Configure the service host deployment](/tomtom-digital-cockpit/developers/tutorials-and-examples/voice-personal-assistant/create-a-custom-alexa-handler-service#configure-the-service-host-deployment)
