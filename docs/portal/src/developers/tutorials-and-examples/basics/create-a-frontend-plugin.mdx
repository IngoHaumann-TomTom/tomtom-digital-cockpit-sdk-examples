...
<Blockquote type="announcement">
    See [this page](https://developer.android.com/topic/libraries/data-binding/expressions) for 
    more information on how data-binding works in Android and how the `ViewModel` class binds to 
    the XML layout. It also explains how the `TtiviAccountLoginFragmentBinding` class that you pass 
...
[Integrate TomTom Digital Cockpit into a Gradle Project](/tomtom-digital-cockpit/developers/tutorials-and-examples/setup/integrate-tomtom-digital-cockpit-into-a-gradle-project#module-references)
for details.
...
[Frontend Plugins](/tomtom-digital-cockpit/developers/development/frontend-plugins)
refer to section
[Calling service methods](/tomtom-digital-cockpit/developers/development/ivi-services#calling-service-methods).
