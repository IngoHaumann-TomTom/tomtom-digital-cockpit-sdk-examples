...
[IVI Services](/tomtom-digital-cockpit/developers/development/ivi-services) for more details about IVI
...
The [`RuntimeConfigurator.globalDeployments`](TTIVI_GRADLEPLUGINS_API) will contain the
...
configuration: the
[`RuntimeDeploymentIdentifier.Companion.globalRuntime`](TTIVI_GRADLEPLUGINS_API). However, it is
...
The [`RuntimeConfigurator.multipleInstanceDeployments`](TTIVI_GRADLEPLUGINS_API) will
...
[com.tomtom.ivi.platform.gradle.api.defaults.config](TTIVI_GRADLEPLUGINS_API) and in the
