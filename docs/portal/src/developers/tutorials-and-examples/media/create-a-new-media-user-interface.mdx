...
[appropriately customized](/tomtom-digital-cockpit/developers/tutorials-and-examples/media/customize-a-media-source).
...
[frontend plugin guide](/tomtom-digital-cockpit/developers/tutorials-and-examples/basics/create-a-frontend-plugin)
to get started.
