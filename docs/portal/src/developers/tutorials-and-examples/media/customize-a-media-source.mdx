...
[create a new user interface](/tomtom-digital-cockpit/developers/tutorials-and-examples/media/create-a-new-media-user-interface).
...
[media overview](/tomtom-digital-cockpit/developers/development/platform-domains/media)
...
this guide:
[How to configure the media plugins](/tomtom-digital-cockpit/developers/tutorials-and-examples/media/configure-the-media-plugins).
...
interface would display the [`IviMediaItem.title`](TTIVI_PLATFORM_API)` field of a playable media
item in a more visually-prominent fashion (in bold and with a bigger font size) and the
[`IviMediaItem.subtitle`](TTIVI_PLATFORM_API) field, when present, in a less-prominent fashion
...
[`IviMediaItem.title`](TTIVI_PLATFORM_API) field set to the name of the station; its
[`IviMediaItem.subtitle`](TTIVI_PLATFORM_API) field set to the full current track name,
"Artist - Track Name"; and its [`IviMediaItem.artist`](TTIVI_PLATFORM_API) field is left
empty.
...
maybe the [`IviMediaItem.id`](TTIVI_PLATFORM_API) should be parsed to find out what type of
...
The guide on
[How to create a frontend plugin](/tomtom-digital-cockpit/developers/tutorials-and-examples/basics/create-a-frontend-plugin)
