...
configuration class that inherits from the [`IviServiceHostConfig`](TTIVI_GRADLEPLUGINS_API)
...
The [`ContactsService.contacts`](TTIVI_PLATFORM_API) and
[`ContactsService.phoneBookSynchronizationStatus`](TTIVI_PLATFORM_API) properties have been
initialized.
