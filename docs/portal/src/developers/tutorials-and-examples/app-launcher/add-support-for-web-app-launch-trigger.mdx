...
<manifest xmlns:android="http://schemas.android.com/apk/res/android">
    <permission android:name="com.example.ivi.example.applauncher.APP_LAUNCH_BROADCAST_PERMISSION" />
</manifest>
```
...
`broadcastPermission` parameter when calling `registerReceiver()` in order to verify it with `adb`.
