...
- [Custom Frontend Coordination Rule](/tomtom-digital-cockpit/developers/tutorials-and-examples/custom-system-ui/custom-frontend-coordination-rule)
This guide explains how to create a custom frontend coordination rule, and how to use it in a custom system UI host.
