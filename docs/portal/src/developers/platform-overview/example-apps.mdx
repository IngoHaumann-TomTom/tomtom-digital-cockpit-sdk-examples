...
[this section](/tomtom-digital-cockpit/developers/tutorials-and-examples/setup/configure-an-app-store).
...
that explain how to
[create a new frontend](/tomtom-digital-cockpit/developers/tutorials-and-examples/basics/create-a-frontend-plugin)
