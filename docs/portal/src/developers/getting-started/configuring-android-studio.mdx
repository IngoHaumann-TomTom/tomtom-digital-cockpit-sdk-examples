...
<Blockquote type="warning" hasIcon>
    **Ignore this upgrade!** The TomTom Digital Cockpit build files specify the exact version of the
...
[TomTom Digital Cockpit template app](/tomtom-digital-cockpit/developers/platform-overview/example-apps)
and the
[TomTom Digital Cockpit example apps](/tomtom-digital-cockpit/developers/tutorials-and-examples/overview#example-applications).
...
- From your local clone of the
  [TomTom Digital Cockpit Example sources](/tomtom-digital-cockpit/developers/getting-started/accessing-tomtom-digital-cockpit-sdk-example-sources),
...
- Under `Gradle JDK` select the OpenJDK version that you
  [downloaded earlier](/tomtom-digital-cockpit/developers/getting-started/installing-openjdk-11)
  (normally shown under `JAVA_HOME`) and click `OK`.
...
__Next step:__ [The TomTom Digital Cockpit Emulator](/tomtom-digital-cockpit/developers/getting-started/the-tomtom-digital-cockpit-emulator)
