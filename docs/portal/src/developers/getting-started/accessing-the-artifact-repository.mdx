...
[signed Evaluation Agreement](https://developer.tomtom.com/tomtom-digital-cockpit/developers/getting-started/introduction),
...
__Next step:__
[Configuring Android Studio](/tomtom-digital-cockpit/developers/getting-started/configuring-android-studio)
