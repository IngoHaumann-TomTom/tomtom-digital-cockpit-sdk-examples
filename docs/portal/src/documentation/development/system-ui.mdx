...
implementation of [`IviFragment`](TTIVI_PLATFORM_API)`.onViewCreated` binds the `iviFragmentId` data
binding variable. You can add the following to the Fragment view XML to declare the `iviFragmentId`
