...
<Blockquote type="announcement" hasIcon>
    [Additional requirements](https://developer.tomtom.com/tomtom-digital-cockpit/documentation/integrating/integrating-amazon-alexa#register-your-alexa-product-with-amazon) exist for using Amazon Alexa in your TomTom Digital Cockpit product.
</Blockquote>
