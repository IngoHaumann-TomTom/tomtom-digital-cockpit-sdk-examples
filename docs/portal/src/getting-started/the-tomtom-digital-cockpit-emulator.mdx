...
- Add another `SDK Update Sites` entry:
  ...
  - Tick `Use Authentication`, enter your TomTom
    [repository credentials](/tomtom-digital-cockpit/getting-started/introduction)
    and click `OK`.
...
- You will now see the TomTom Digital Cockpit home screen. Note that map data only shows when you
  have
  [installed an on-board map](/tomtom-digital-cockpit/getting-started/accessing-the-map-data)
...
__Next step:__
[Accessing the Map Data](/tomtom-digital-cockpit/getting-started/accessing-the-map-data)
