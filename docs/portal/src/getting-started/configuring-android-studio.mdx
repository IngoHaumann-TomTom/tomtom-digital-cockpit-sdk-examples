...
- From your local clone of the
  [TomTom Digital Cockpit Example sources](/tomtom-digital-cockpit/getting-started/accessing-tomtom-digital-cockpit-sdk-example-sources),
...
- Under `Gradle JDK` select the OpenJDK version that you
  [downloaded earlier](/tomtom-digital-cockpit/getting-started/installing-openjdk-11)
...
__Next step:__ [The TomTom Digital Cockpit Emulator](/tomtom-digital-cockpit/getting-started/the-tomtom-digital-cockpit-emulator)
