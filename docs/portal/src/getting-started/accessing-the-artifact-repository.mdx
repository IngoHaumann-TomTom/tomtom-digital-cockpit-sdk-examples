...
[signed Evaluation Agreement](https://developer.tomtom.com/tomtom-digital-cockpit/getting-started/introduction),
...
__Next step:__
[Getting a TomTom API Key](/tomtom-digital-cockpit/getting-started/getting-a-tomtom-api-key)
